...
public interface TetrominoFactory {
    ...
    /**
     * Erstellt den {@link TetrominoTyp} eines {@link TetrominoSpielstein}s, also ob
     * es ein L, ein Block etc. ist. Erstellt noch nicht den Spielstein selbst.
     * 
    ...
    /**
     * Erstellt einen Tetromino-Spielstein mit dem Typ, der als Parameter angegeben
     * ist.
     * 
     * @param tetrominoTyp {@link TetrominoTyp}
    ...
    /**
     * Erstellt einen Tetromino-Spielstein mit dem Typ, der als Parameter angegeben
     * ist, mit den angegebenen x- und y-Koordinaten.
     * 
     * @param tetrominoTyp {@link TetrominoTyp}
     * @param x            Koordinate
     * @param y            Koordinate
